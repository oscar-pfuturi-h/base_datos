...
<div id="content">
	...
	<div id="log-block">
		...
		<div id="content">
			...
			<form method="POST" action="valida_signin.php">
				<div id="fname" class="in-block">
					<div class="label">
			...
			<div id="btn2">
				...
				<button type="button" onclick="window.location.href='iniciasesion.php'">Iniciar Sesión</button>
			</div>
